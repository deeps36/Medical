...
if (!defined('__CSRF_PROTECTOR__')) {
    ...
    class csrfProtector
    {
        ...
        public static function init($length = null, $action = null, $logger = null)
        {
            ...
            $composer_config_location = __DIR__ ."/../../../../../src/config/csrf_config.php";
        ...
        public static function ob_handler($buffer, $flags)
        {
            ...
            $tokenField = '<input type="hidden" id="scrtkn" name="scrtkn" value="'.end($_SESSION[self::$config['CSRFP_TOKEN']])
            .'">';
            $buffer = str_ireplace('</body>', $tokenField . '</body>', $buffer);
