...
<script type="text/javascript">
	...
	<div class="large-12 small-12 columns">
		<a href="/Faq/getNewFaq"><div class="button">Add new FAQ</div></a>
		<br />
	</div>
						...
						if($faqs['responseType'] === '1'){
							foreach($faqs['text'] as $record){
								$html .= '<tr>
									...
									<td>'.$record['weight'].'</td>
									<td>
										<a class="inlineBlock" id="'.$record['id'].'" style="cursor: pointer;" href="/Faq/getFaq?id='.$record['id'].'">Update</a>
										<a class="inlineBlock" id="'.$record['id'].'" style="cursor: pointer;" href="/Faq/deleteFaq?id='.$record['id'].'" onclick="return confirm(\'Are you sure you want to delete this? This will permanently delete selected FAQ\')">Delete</a>
									</td>
								</tr>';
								$i++;
							}
