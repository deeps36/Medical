...
<script type="text/javascript">
	...
	<div class="small-12 large-12 columns">
		<br/><h6 class="titleBar">List Label</h6>
		<br />
	</div>
	<div class="large-12 small-12 columns">
		<a href="/Label/getNewLabel"><div class="button">Add New Label</div></a>
		<br />
	</div>
						...
						if($label['responseType'] === '1'){
							foreach($label['text'] as $record){
								$html .= '<tr>
									...
									<td>
										<a class="inlineBlock" id="'.$record['id'].'" style="cursor: pointer;" href="/Label/getUpdateLabel?id='.$record['id'].'">Update</a></td>
										<td><a class="inlineBlock" id="'.$record['id'].'" style="cursor: pointer;" href="/Label/deleteLabel?id='.$record['id'].'" onclick="return confirm(\'Are you sure you want to delete this? This will permanently delete selected Label\')">Delete</a>
									</td>
								</tr>';
								$i++;
							}
