...
<div class="small-12 large-12 columns">
	<br/><h6 class="titleBar">List Question</h6>
	<br />
</div>
			...
			<tbody>
				<?php
					...
					if($question['responseType'] === '1'){
						...
						foreach($question['text'] as $record){
							...
							$html .= '<tr>
								...
								<td><a class="inlineBlock" id="id" value="'.$record['que_id'].'" style="cursor: pointer;" href="/Question/getQuestionTranslation?id='.$record['que_uid'].'">Translation</a></td>
