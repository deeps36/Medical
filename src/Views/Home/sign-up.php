...
<head>
		...
		<link rel="shortcut icon" href="/html/metronic8/demo2/assets/media/logos/favicon.ico" />
		<!--begin::Fonts-->
		<link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700" />
		<!--end::Fonts-->
		<!--begin::Global Stylesheets Bundle(used by all pages)-->
		<link href="/html/metronic8/demo2/assets/plugins/global/plugins.bundle.css" rel="stylesheet" type="text/css" />
	...
	<body id="kt_body" class="bg-body">
				...
				<div class="d-flex flex-center flex-column flex-column-fluid p-10 pb-lg-20">
					...
					<div class="w-lg-900px bg-body rounded shadow-sm p-10 p-lg-15 mx-auto">
						...
						<form class="form w-80" novalidate="novalidate" id="kt_sign_up_form">
							...
							<!--begin::Input group-->
							<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Upload Photo *</label>
							...
							<div class="row fv-row mb-12">
								...
								<div class="col-xl-6">
									<label class="form-label fw-bolder text-dark fs-6">Email Id *</label>
							...
							<div class="row fv-row mb-8">
								...
								<div class="col-xl-4">
										...
										<input class="form-control form-control-lg form-control-solid" type="text" placeholder="" name="state" autocomplete="off" />
								</div>
								<div class="col-xl-4">
							...
							<div class="row fv-row mb-12">
								<div class="col-xl-6">
									...
									<label class="form-label fw-bolder text-dark fs-6">With ECFMG Certification *</label>
									
								</div>
								<div class="col-xl-6">
									<input  type="radio" id="select"/>
									<label class="form-label fw-bolder text-dark fs-6">Without ECFMG Certification *</label>
								</div>
							</div>
							<div class="row fv-row mb-12">
								<div class="col-xl-6">
									<input  type="file"/>
									<label class="form-label fw-bolder text-dark fs-6">ECFMG Certification *</label>
									
								</div>
								<div class="col-xl-6">
									<input  type="file"/>
									<label class="form-label fw-bolder text-dark fs-6">Identity Proof *</label>
								</div>
							</div>
							<div class="fv-row mb-6">
		...
		<script src="/html/metronic8/demo2/assets/js/custom/authentication/sign-up/general.js"></script>
