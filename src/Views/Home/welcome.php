                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-12 m-auto">
                        <div class="hero-text">
                            ...
                            <h1 class="text-white mb-4"><u class="text-info">Global Scholars League</u> </h1>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <h2 class="mb-5 text-center">Research <u class="text-info">Publications</u></h2>
                            ...
                            <div class="tab-pane fade show active" id="nav-DayOne" role="tabpanel" aria-labelledby="nav-DayOne-tab">
                                <div class="row border-bottom pb-5 mb-5">
                                    ...
                                    <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                        ...
                                        <h4 class="mb-2">Publication 1</h4>
                                        ...
                                        <div class="d-flex align-items-center mt-4">
                                            <div class="avatar-group d-flex">
                                                ...
                                                <div class="ms-3">
                                                    Author Name
                                                    <p class="speakers-text mb-0">qualification</p>
                                                </div>
                                            </div>
                                ...
                                <div class="row border-bottom pb-5 mb-5">
                                    ...
                                    <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                        <h4 class="mb-2">Publication 2</h4>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-8 col-12 mt-3 mt-lg-0">
                                        <h4 class="mb-2">Publication 3</h4>
        ...
        <section class="schedule section-padding" id="section_4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-12 col-12">
                        <h2 class="mb-5 text-center">Research <u class="text-info">Projects</u></h2>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-10 col-12 text-center mx-auto mb-5">
                        <h2>Mentors <u class="text-info"></u></h2>
                    </div>
                    ...
                    <div class="col-lg-4 col-md-6 col-12 mb-5 mb-lg-0">
                        <div class="pricing-thumb bg-white shadow-lg">
                            <div class="pricing-title-wrap d-flex align-items-center">
                                <h4 class="pricing-title text-white mb-0">Mentor Name</h4>
                            </div>
                            <div class="pricing-body" >
                                <p>
                                    <img src="/image/download.jpg" style="display: block;margin-left: auto;margin-right: auto;"></img>
                                </p>
                            </div>
                        </div>
                    </div>
